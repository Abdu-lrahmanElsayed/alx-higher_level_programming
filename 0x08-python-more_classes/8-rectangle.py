...
class Rectangle:
    ...
    def area(self):
        """Instance method to calculate rectangle area"""
        return self.__height * self.__width

    def perimeter(self):
        """Instance method to calculate rectangle perimeter"""
    ...
    def __del__(self):
        """to print a message when a rectangle is deleted"""
        Rectangle.number_of_instances -= 1
        print("Bye rectangle...")

    @staticmethod
    def bigger_or_equal(rect_1, rect_2):
        """A static methodthat returns the biggest rectangle based on the area
        """
